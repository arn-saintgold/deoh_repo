...
usr_dyad_cols<-c("love", "submission", "curiosity", "sentimentality", "hope","dominance", "ambivalence", "optimism", "guilt", "pride" ,"delight","morbidness", "bittersweetness", "alarm", "despair", "anxiety" ,"shame","frozenness", "contempt", "aggressiveness", "envy", "outrage" ,"cynism","pessimism", "confusion", "disappointment", "remorse", "unbelief")
